...
public class ListProduct extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        if (tblProducts.getColumnModel().getColumnCount() > 0) {
            ...
            tblProducts.getColumnModel().getColumn(1).setMinWidth(220);
            tblProducts.getColumnModel().getColumn(1).setPreferredWidth(220);
            tblProducts.getColumnModel().getColumn(1).setMaxWidth(220);
            ...
            tblProducts.getColumnModel().getColumn(3).setMinWidth(170);
            tblProducts.getColumnModel().getColumn(3).setPreferredWidth(170);
            tblProducts.getColumnModel().getColumn(3).setMaxWidth(170);
        }
